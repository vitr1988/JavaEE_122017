 ...
 * generated in the ru.otus.jaxws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetCurrentDate_QNAME = new QName("http://jaxws.otus.ru/", "getCurrentDate");
    private final static QName _GetCurrentDateResponse_QNAME = new QName("http://jaxws.otus.ru/", "getCurrentDateResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.otus.jaxws.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.otus.ru/", name = "getCurrentDate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.otus.ru/", name = "getCurrentDateResponse")
