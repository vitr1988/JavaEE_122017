...
public class EJBClient {
    public static void main(String[] args) throws Exception {
        ...
        SimpleBean bean = (SimpleBean) context.lookup("java:global/JavaEE_122017-1.0-SNAPSHOT/SimpleBean!ru.otus.ejb.session.SimpleBean");
        //work with interface.. not implementation (proxy)
        EmployeeManageable dataBean = (EmployeeManageable) context.lookup("java:global/JavaEE_122017-1.0-SNAPSHOT/PersistenceBean!ru.otus.ejb.session.EmployeeManageable");
...
//        SimpleBean bean3 = (SimpleBean) context.lookup("java:module/Example!ru.otus.ejb.session.SimpleBean");
        ...
        EmployeeCacheable cacheBean = (EmployeeCacheable) context.lookup("java:global/JavaEE_122017-1.0-SNAPSHOT/SingletonBean!ru.otus.ejb.session.EmployeeCacheable");
        ...
        String employee = cacheBean.get(7935L);
